...
-- | A tape is 'Applicative', where the "apply" is the same as its ComonadApply instance (required by
--   law), and a pure value is the tape consisting of copies of that value in both directions.
